...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/6.4.2/mdb.min.js"></script>
	...
	<link rel="stylesheet" href="../indexhomestyle.css">
	<style>
		*{
	font-size: 15px;
}
  ...
  <nav class="navbar navbar-expand-lg navbar-scroll fixed-top shadow-0 border-bottom border-dark">
        <div class="container ">
            <a class="navbar-brand" href="#"><img src="../images/p3.png" alt=""><strong>M-Grievance Portal</strong></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/Complaint Management System/about.html"><i class="fas fa-comment-dots"></i>About Us</a>
                    </li>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" name="submit" type="submit" style='font-size: 15px;'><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
		           </form>
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
      ...
      <section class="">
        <!-- Footer -->
        <footer class="text-center text-white" style="background-color: aqua;">
          
          <!-- Grid container -->
      
          <!-- Copyright -->
          <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © Made by Sahil, Omkar, Suyash, Aryan
